...
static std::unordered_map<std::string, size_t> pointerList[14];
...
void InitBedrockPointers() {
	...
	pointerList[5]["1.14.60.5"] = 0x19597B0;
	pointerList[5]["1.16.0.2"] = 0x1AAF790;
	pointerList[6]["1.14.60.5"] = 0x1959900;
	pointerList[6]["1.16.0.2"] = 0x1AAF8E0;
	pointerList[7]["1.14.60.5"] = 0x079D610;
	pointerList[7]["1.16.0.2"] = 0x07FEBB0;
	pointerList[8]["1.14.60.5"] = 0x07A4E20;
	pointerList[8]["1.16.0.2"] = 0x0806630;
	pointerList[9]["1.14.60.5"] = 0x1AA0FC0;
	pointerList[9]["1.16.0.2"] = 0x1CC0A40;
	pointerList[10]["1.14.60.5"] = 0x1AA3860;
	pointerList[10]["1.16.0.2"] = 0x1CC2B50;
	pointerList[11]["1.14.60.5"] = 0x1AAEB80;
	pointerList[11]["1.16.0.2"] = 0x1CCCEB0;
	pointerList[12]["1.14.60.5"] = 0x1AB07D0;
	pointerList[12]["1.16.0.2"] = 0x1CCEB90;
	pointerList[13]["1.14.60.5"] = 0x0305470;
	pointerList[13]["1.16.0.2"] = 0x0338980;
}
...
void InitVersionPointers(std::string versionId) {
	...
	_registerButtonDownHandler_InputHandler__QEAAXV_$basic_string_DU_$char_traits_D_std__V_$allocator_D_2__std__V_$function_$$A6AXW4FocusImpact__AEAVIClientInstance___Z_3__N_Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[5][versionId]));
	_registerButtonUpHandler_InputHandler__QEAAXV_$basic_string_DU_$char_traits_D_std__V_$allocator_D_2__std__V_$function_$$A6AXW4FocusImpact__AEAVIClientInstance___Z_3__N_Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[6][versionId]));
	__registerInputHandlers_MinecraftInputHandler__QEAAXXZ_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[7][versionId]));
	_assignDefaultMapping_RemappingLayout__QEAAX$$QEAV_$vector_VKeymapping__V_$allocator_VKeymapping___std___std___Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[8][versionId]));
	__populateKeyboardDefaults_VanillaClientInputMappingFactory__QEAAXAEAVRemappingLayout___Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[9][versionId]));
	__populateGamepadDefaults_VanillaClientInputMappingFactory__QEAAXAEAVRemappingLayout___Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[10][versionId]));
	__addFullKeyboardGamePlayControls_VanillaClientInputMappingFactory__QEAAXAEAVKeyboardInputMapping__AEAVMouseInputMapping___Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[11][versionId]));
	__addInvariantGamePlayGameControllerControls_VanillaClientInputMappingFactory__QEAAXAEAVGameControllerInputMapping__W4MappingControllerType_ClientInputMappingFactory___Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[12][versionId]));
	__handleDuplicates_ControlsSettingsScreenController__QEAAXAEAVRemappingLayout___Z_ptr = reinterpret_cast<void*>(Zenova::Hook::SlideAddress(pointerList[13][versionId]));
}